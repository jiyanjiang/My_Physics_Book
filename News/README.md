...
Quantum machines have a noise threshold past which classical machines cannot best them, researchers have learnt. 存在噪声阈值，大于这个阈值时，经典计算就可与量子计算匹敌，否则就存在量子优势。
...
你的手机现在就放在手边，你一直没动过它，但你真就没有被它干扰、真的挣脱了它对你大脑的影响吗？根据2017年的一项著名研究，答案是否定的。该研究提出了“认知流失假说”(brain drain hypothesis)，证明只要把手机放在身边，它就会影响你的认知，特别是你的工作记忆，也就是帮助我们在特定时刻掌握当前所做之事相关信息的认知系统。例如，告诉自己不去想身边的手机，也会消耗一些认知资源。然而，在一项新的荟萃分析中，研究人员对27项不同“认知流失”研究的数据进行了分析，发现对于主要的五种认知功能，即工作记忆、持续性注意力、抑制控制、认知灵活性和流体智力，手机的存在仅对工作记忆有负面影响，且比2017年的那项研究所表明的影响要小得多。

https://psyarxiv.com/tnyda/
...
- 2303.05987 [True superconductivity at near ambient temperature has not been confirmed by Dasenbrock-Gammon, et. al. Nature (2023)](https://arxiv.org/abs/2303.05987) bad quality
- [Feynman's Lecture on Computer](https://www.youtube.com/watch?v=EKWGGDXe5MA)
...
- [Abstract: K20.00002 : Observation of Room Temperature Superconductivity in Hydride at Near Ambient Pressure](https://meetings.aps.org/Meeting/MAR23/Session/K20.2)
